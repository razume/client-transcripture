...
function App() {
  ...
  return (
    <ThemeProvider theme={theme}>
      {authCode ? <Dashboard setAuthCode={setAuthCode} clientID={clientID} redirectURL={redirectURL} posturl={posturl} /> : <Login clientID={clientID} redirectURL={redirectURL} posturl={posturl} />}
    </ThemeProvider>
  )
}
